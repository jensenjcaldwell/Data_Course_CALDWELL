...
user in an INI file next to PicPickPortable.exe called PicPickPortable.ini.
...
copy AppNamePortable.ini from this directory to PicPickPortable.ini next to
PicPickPortable.exe. The options in the INI file are as follows:
